...
def getTestimonial(request):
    template = loader.get_template('for_student.html')
    context = RequestContext(request,{})
    return HttpResponse(template.render(context))
...
def getFAQ(request):
    template = loader.get_template('for_tutor.html')
    context = RequestContext(request,{})
    return HttpResponse(template.render(context))
...
def getTestimonialZH(request):
    template = loader.get_template('for_student_zh.html')
    context = RequestContext(request,{})
    return HttpResponse(template.render(context))
...
def getFAQZH(request):
    template = loader.get_template('for_tutor_zh.html')
    context = RequestContext(request,{})
    return HttpResponse(template.render(context))